...
Enter the package repository URL: https://github.com/argmaxinc/argmax-oss-swift.
Choose the version range or specific version.
When prompted to choose library products, select ArgmaxOSS (all kits), or individual kits: WhisperKit, TTSKit, SpeakerKit.
Package.swift
